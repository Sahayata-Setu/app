...
class NeedServiceClass {
  ...
  Future<Map<String, dynamic>> createNeed(data, image, date) async {
    ...
    try {
      ...
      log("this is response from need post ${response}");
      return response;
    } catch (e) {
      log("this is error$e");
      throw e;
...
final needService = Provider<NeedServiceClass>((ref) => NeedServiceClass());
