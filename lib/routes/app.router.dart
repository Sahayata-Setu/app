...
import 'package:donationapp/constant/common/splashScreen.dart/splashScreen.dart';
...
@MaterialAutoRouter(routes: [
  MaterialRoute(page: Splash, initial: true, path: "/splash"),

  MaterialRoute(page: AuthCheckWidget, path: "/"),
