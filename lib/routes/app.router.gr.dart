...
import '../features/Admin/Dashboard/adminDashboard.dart' as _i25;
...
class AppRouter extends _i27.RootStackRouter {
  ...
  final Map<String, _i27.PageFactory> pagesMap = {
    ...
    AdminDashboardRoute.name: (routeData) {
      return _i27.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i25.AdminDashboard());
    },
  ...
  List<_i27.RouteConfig> get routes => [
        ...
        _i27.RouteConfig(AdminDashboardRoute.name, path: '/admin-dashboard'),
