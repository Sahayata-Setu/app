...
import '../features/message/messageDetails.dart' as _i10;
...
class AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    MessageDetailsRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.MessageDetails());
    },
  ...
  List<_i23.RouteConfig> get routes => [
        ...
        _i23.RouteConfig(MessageDetailsRoute.name, path: '/messages-details'),
        ...
        _i23.RouteConfig(UserProfileRoute.name, path: '/user-profile'),
...
/// generated route for
/// [_i10.MessageDetails]
class MessageDetailsRoute extends _i23.PageRouteInfo<void> {
  const MessageDetailsRoute()
      : super(MessageDetailsRoute.name, path: '/messages-details');
